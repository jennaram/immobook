                ...
                <div class="p-6 text-gray-900">
                    ...
                    @if (!auth()->user()->is_admin)
                        <div class="bg-red-100 p-4 rounded-lg mb-6">
                            <p class="text-red-800">Vous devez être administrateur pour accéder à cette page.</p>
                        </div>
                    @else
                        <div class="bg-green-100 p-4 rounded-lg mb-6">
                            <p class="text-green-800">Bienvenue administrateur !</p>
                        </div>
                                        ...
                                        <tbody>
                                            @foreach ($upcomingBookings as $booking)
                                                <tr>
                                                    ...
                                                    <td class="py-2 px-4 border-b">{{ $booking->check_in->format('d/m/Y') }}
                                                    </td>
                                        ...
                                        <tbody>
                                            @foreach ($pastBookings as $booking)
                                                <tr>
                                                    ...
                                                    <td class="py-2 px-4 border-b">
                                                        {{ $booking->check_out->format('d/m/Y') }}</td>
                                                    <td class="py-2 px-4 border-b">{{ $booking->total_price ?? 'N/A' }} €
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
