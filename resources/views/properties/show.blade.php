                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div x-data="{ showMore: false }">
                                <div class="relative overflow-hidden transition-all duration-300"
                                    :class="showMore ? 'max-h-full' : 'max-h-24'">
                                    <p class="text-gray-700 leading-relaxed">
                                        {{ $property->description ?? 'Non renseignée' }}
                                    </p>
                                    <div x-show="!showMore"
                                        class="absolute bottom-0 left-0 w-full bg-gradient-to-t from-white via-white/80 to-transparent h-10">
                                    </div>
                                </div>
                        ...
                        <div class="mb-4">
                            <p class="text-gray-700"><strong>Prix par nuit :</strong>
                                {{ $property->price_per_night ?? 'Non renseigné' }} €</p>
                            ...
                            <div class="mt-4">
                                <button onclick="toggleFavorite({{ $property->id }})"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" data-property-id="{{ $property->id }}">
                            ...
                            <div class="mt-4 flex justify-center">
                                @auth
                                    ...
                                    <a href="{{ route('bookings.create', ['property_id' => $property->id]) }}"
                                        class="inline-flex items-center px-4 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition duration-300 transform hover:scale-105 shadow-md">
                                ...
                                @else
                                    ...
                                    <div class="text-center mt-2">
                                        ...
                                        <div class="mt-2 space-x-4">
                                            <a href="{{ route('login') }}" class="text-blue-600 hover:text-blue-800">Se
                                                connecter</a>
                                            <span class="text-gray-400">|</span>
                                            <a href="{{ route('register') }}"
                                                class="text-blue-600 hover:text-blue-800">S'inscrire</a>
                                        </div>
                                    </div>
                                @endauth
                            </div>
                        ...
                        <!-- Adresse -->
                        <div class="mb-4">
                            <p class="text-gray-700"><strong>Adresse :</strong>
                                {{ $property->address ?? 'Non renseignée' }}</p>
                        </div>

                        <!-- Nombre de chambres -->
                        <div class="mb-4">
                            <p class="text-gray-700"><strong>Nombre de chambres :</strong>
                                {{ $property->bedrooms ?? 'Non renseigné' }}</p>
                        </div>
