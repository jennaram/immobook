    ...
    <div class="container mx-auto px-6 py-12">
        ...
        <div class="bg-white rounded-lg shadow-md p-8 max-w-3xl mx-auto mt-8">
            ...
            <p class="text-lg text-gray-700 text-center mb-6">
                Notre mission est de simplifier la gestion des propriétés et de rendre votre séjour aussi agréable que
                possible.
            </p>
            <p class="text-lg text-gray-700 text-center mb-8">
                N'hésitez pas à <a href="{{ route('contact') }}" class="text-indigo-600 hover:text-indigo-800 underline">nous
                    contacter</a> si vous avez des questions ou des suggestions.
            </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition-shadow duration-300">
                    <a href="https://www.linkedin.com/in/jennabenufferamia/" target="_blank" rel="noopener noreferrer">
                        <img src="{{ asset('images/logo_linkedin.png') }}" alt="LinkedIn"
                            class="w-20 h-20 rounded-full mx-auto mb-4 hover:scale-110 transition-transform duration-300">
                    </a>
